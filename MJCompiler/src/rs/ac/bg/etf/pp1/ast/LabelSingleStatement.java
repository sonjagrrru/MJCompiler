...
public class LabelSingleStatement extends Statement {

    private Label Label;
    private SingleStatement SingleStatement;

    public LabelSingleStatement (Label Label, SingleStatement SingleStatement) {
        this.Label=Label;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("LabelSingleStatement(\n");

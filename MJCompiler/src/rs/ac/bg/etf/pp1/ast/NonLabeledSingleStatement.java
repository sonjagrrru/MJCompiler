...
public class NonLabeledSingleStatement extends Statement {

    private SingleStatement SingleStatement;

    public NonLabeledSingleStatement (SingleStatement SingleStatement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("NonLabeledSingleStatement(\n");
